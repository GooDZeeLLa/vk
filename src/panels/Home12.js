...
const Home = ({ id, go,false1, fetchedUser }) => (
	<Panel id={id}>
		...
		<Group title="Navigation Example">
			<Div>
			             В какое время  суток работоспособность  человека наиболее низкая?
				<Button size="xl" level="2" onClick={false1} data-to="home13">
					С 17 до 21
				</Button>

				<Button2 size="xl" level="2" onClick={false1} data-to="home13">
					С 5 до 9
				</Button2>
				<Button3 size="xl" level="2" onClick={false1} data-to="home13">
					С 21 до 1
				</Button3>
				<Button4 size="xl" level="2" onClick={go} data-to="home13">
					С 1 до 5
				</Button4>
			</Div>
		</Group>
