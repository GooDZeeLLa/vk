...
const Home = ({ id, go,false1, fetchedUser }) => (
	<Panel id={id}>
		...
		<Group title="Navigation Example">
			<Div>
			             Что такое витамины?
				<Button size="xl" level="2" onClick={false1} data-to="home4">
					Неорганические химические соединения,необходимые для работы организма
				</Button>

				<Button2 size="xl" level="2" onClick={go} data-to="home4">
					Органические химические соединения,необходимые для синтеза белков-ферментов
				</Button2>
				<Button3 size="xl" level="2" onClick={false1} data-to="home4">
					Органические химические соединения,являющиеся ферментами
				</Button3>
				<Button4 size="xl" level="2" onClick={false1} data-to="home4">
					Органические химические соединения, содержащиеся в продуктах питания
				</Button4>
			</Div>
		</Group>
	</Panel>
