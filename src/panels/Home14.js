	...
	<Panel id={id}>
		...
		<Group title="Navigation Example">
			<Div>
				...
				<Button size="xl" level="2" onClick={false1} data-to="persik">
					Физического благополучия
				</Button>

				<Button2 size="xl" level="2" onClick={false1} data-to="persik">
					Социального благополучия
				</Button2>
				<Button3 size="xl" level="2" onClick={go} data-to="persik">
					Все ответы верны
				</Button3>
				<Button4 size="xl" level="2" onClick={false1} data-to="persik">
