...
const Home = ({ id, go,false1, fetchedUser }) => (
	<Panel id={id}>
		...
		<Group title="Navigation Example">
			<Div>
			             Что такое режим дня?
				<Button size="xl" level="2" onClick={false1} data-to="home2">
					Порядок выполнения повседневных дел
				</Button>

				<Button2 size="xl" level="2" onClick={false1} data-to="home2">
					Строгое соблюдение определенных правил
				</Button2>
				<Button3 size="xl" level="2" onClick={false1} data-to="home2">
					Перечень повседневных дел, распределенных по времени выполнения
				</Button3>
				<Button4 size="xl" level="2" onClick={go} data-to="home2">
