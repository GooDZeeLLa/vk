	...
	<Panel id={id}>
		...
		<Group title="Navigation Example">
			<Div>
				...
				<Button size="xl" level="2" onClick={false1} data-to="home6">
					Занятие физической культурой и спортом
				</Button>

				<Button2 size="xl" level="2" onClick={false1} data-to="home6">
					Выполнение каких-либо движений в повседневной деятельности
				</Button2>
				<Button3 size="xl" level="2" onClick={go} data-to="home6">
					Любая мышечная активность, обеспечивающая оптимальную работу организма и хорошее самочувствие
				</Button3>
				<Button4 size="xl" level="2" onClick={false1} data-to="home6">
					Количество движений, необходимых для работы организма
				</Button4>
			</Div>
		</Group>
	</Panel>
