	...
	<Panel id={id}>
		...
		<Group title="Navigation Example">
			<Div>
				...
				<Button size="xl" level="2" onClick={false1} data-to="home3">
					Питание, распределенное по времени принятия пищи
				</Button>

				<Button2 size="xl" level="2" onClick={false1} data-to="home3">
					Питание с определенным соотношением питательных веществ
				</Button2>
				<Button3 size="xl" level="2" onClick={go} data-to="home3">
					Питание с учетом потребностей организма
				</Button3>
				<Button4 size="xl" level="2" onClick={false1} data-to="home3">
					Питание с набором определенных продуктов
				</Button4>
			</Div>
		</Group>
	</Panel>
