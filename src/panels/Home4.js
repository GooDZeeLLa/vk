	...
	<Panel id={id}>
		...
		<Group title="Navigation Example">
			<Div>
				...
				<Button size="xl" level="2" onClick={false1} data-to="home5">
					Белки, жиры, углеводы, минеральные соли
				</Button>

				<Button2 size="xl" level="2" onClick={false1} data-to="home5">
					Вода, белки, жиры и углеводы
				</Button2>
				<Button3 size="xl" level="2" onClick={false1} data-to="home5">
					Жиры и углеводы
				</Button3>
				<Button4 size="xl" level="2" onClick={go} data-to="home5">
					Белки, жиры, углеводы
				</Button4>
			</Div>
		</Group>
