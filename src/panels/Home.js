	...
	<Panel id={id}>
		...
		<Group title="Navigation Example">
			<Div>
				...
				<Button size="xl" level="2" onClick={false1} data-to="home1">
					Перечень мероприятий, направленных на укрепление и сохранение здоровья
				</Button>

				<Button2 size="xl" level="2" onClick={false1} data-to="home1">
					Занятия физической культурой
				</Button2>
				<Button3 size="xl" level="2" onClick={go} data-to="home1">
					Индивидуальная система поведения, направленная на сохранение и укрепление здоровья
				</Button3>
				<Button4 size="xl" level="2" onClick={false1} data-to="home1">
