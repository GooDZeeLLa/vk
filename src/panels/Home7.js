	...
	<Panel id={id}>
		...
		<Group title="Navigation Example">
			<Div>
				...
				<Button size="xl" level="2" onClick={false1} data-to="home8">
					Перечень правил для предотвращения инфекционных заболеваний
				</Button>

				<Button2 size="xl" level="2" onClick={go} data-to="home8">
					Совокупность гигиенических правил, выполнение которых способствует сохранению и укреплению здоровья
				</Button2>
				<Button3 size="xl" level="2" onClick={false1} data-to="home8">
					Правила ухода за телом ,кожей, зубами
				</Button3>
				<Button4 size="xl" level="2" onClick={false1} data-to="home8">
