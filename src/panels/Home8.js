...
const Home = ({ id, go,false1, fetchedUser }) => (
	<Panel id={id}>
		...
		<Group title="Navigation Example">
			<Div>
			             Назовите основные двигательные качества
				<Button size="xl" level="2" onClick={false1} data-to="home9">
					Состояние мышц, выражающая их готовность к выполнению движений
				</Button>

				<Button2 size="xl" level="2" onClick={false1} data-to="home9">
					Умение играть в спортивные игры, бегать и выполнять гимнастические упражнения
				</Button2>
				<Button3 size="xl" level="2" onClick={go} data-to="home9">
					Гибкость, выносливость, скоростные и силовые качества
				</Button3>
				<Button4 size="xl" level="2" onClick={false1} data-to="home9">
