	...
	<Panel id={id}>
		...
		<Group title="Navigation Example">
			<Div>
				...
				<Button size="xl" level="2" onClick={go} data-to="home12">
					Все ответы верны
				</Button>

				<Button2 size="xl" level="2" onClick={false1} data-to="home12">
					Научность
				</Button2>
				<Button3 size="xl" level="2" onClick={false1} data-to="home12">
					Объективность
				</Button3>
				<Button4 size="xl" level="2" onClick={false1} data-to="home12">
					Массовость
				</Button4>
			</Div>
		</Group>
