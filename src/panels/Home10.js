...
const Home = ({ id, go,false1, fetchedUser }) => (
	<Panel id={id}>
		...
		<Group title="Navigation Example">
			<Div>
			             ЗОЖ включает:
				<Button size="xl" level="2" onClick={false1} data-to="home11">
					Доступность квалифицированной мед. помощи
				</Button>

				<Button2 size="xl" level="2" onClick={false1} data-to="home11">
					Охрану окружающей среды
				</Button2>
				<Button3 size="xl" level="2" onClick={go} data-to="home11">
					Все ответы верны
				</Button3>
				<Button4 size="xl" level="2" onClick={false1} data-to="home11">
