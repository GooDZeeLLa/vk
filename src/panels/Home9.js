	...
	<Panel id={id}>
		...
		<Group title="Navigation Example">
			<Div>
				...
				<Button size="xl" level="2" onClick={go} data-to="home10">
					ЗОЖ
				</Button>

				<Button2 size="xl" level="2" onClick={false1} data-to="home10">
					Охрана окружающей среды
				</Button2>
				<Button3 size="xl" level="2" onClick={false1} data-to="home10">
					Вакцинация
				</Button3>
				<Button4 size="xl" level="2" onClick={false1} data-to="home10">
